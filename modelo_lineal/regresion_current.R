# -*- coding: utf-8 -*-
"""Regres_lineal_r2.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1NSEIxs8Ao9FsgWj8hRyvNnXHEjM7V47F
...
Al momento de generar bases de entrenamiento y prueba para validación, la primera y más básica aproximación es dividir la base de datos en dos: entrenamiento y prueba. No existe un criterio único y definido para saber qué porcentaje de la base de datos debe entregarse a entrenamiento y cuál a validación. De manera empírica, con frecuencia se usa el 80% de los datos para la base de entrenamiento y el 20% de los datos para la base de validación.
"""
